...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0001-react-native-primary.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0001: React Native primary, native modules only where required

_Source artifact: `s2d/inputs/reference/decisions/0001-react-native-primary.md`. Generated by context-ingest; do not hand-edit._
