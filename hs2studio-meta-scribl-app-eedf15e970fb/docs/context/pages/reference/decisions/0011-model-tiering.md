...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0011-model-tiering.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0011: Model tiering -- Opus for prompt gen, Sonnet for vision, Haiku for moderation

_Source artifact: `s2d/inputs/reference/decisions/0011-model-tiering.md`. Generated by context-ingest; do not hand-edit._
