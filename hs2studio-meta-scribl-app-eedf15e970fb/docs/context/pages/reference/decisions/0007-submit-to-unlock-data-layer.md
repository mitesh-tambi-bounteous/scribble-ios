...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0007-submit-to-unlock-data-layer.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0007: Submit-to-unlock enforced at the data/API layer

_Source artifact: `s2d/inputs/reference/decisions/0007-submit-to-unlock-data-layer.md`. Generated by context-ingest; do not hand-edit._
