...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0002-serverless-first-backend.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0002: Serverless-first backend; Fargate for the AI pipeline

_Source artifact: `s2d/inputs/reference/decisions/0002-serverless-first-backend.md`. Generated by context-ingest; do not hand-edit._
