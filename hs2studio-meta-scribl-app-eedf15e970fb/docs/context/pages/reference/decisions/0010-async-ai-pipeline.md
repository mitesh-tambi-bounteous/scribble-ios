...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0010-async-ai-pipeline.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0010: Drawing interpretation and moderation run async; submit never blocks on AI

_Source artifact: `s2d/inputs/reference/decisions/0010-async-ai-pipeline.md`. Generated by context-ingest; do not hand-edit._
