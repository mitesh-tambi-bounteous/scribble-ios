...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0009-claude-provider-abstraction.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0009: Provider-abstraction layer for Claude (Direct API default)

_Source artifact: `s2d/inputs/reference/decisions/0009-claude-provider-abstraction.md`. Generated by context-ingest; do not hand-edit._
