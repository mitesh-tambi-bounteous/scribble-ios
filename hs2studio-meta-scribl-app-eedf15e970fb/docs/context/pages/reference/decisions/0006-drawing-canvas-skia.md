...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0006-drawing-canvas-skia.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0006: Drawing canvas via React Native Skia; voice transcribed on-device

_Source artifact: `s2d/inputs/reference/decisions/0006-drawing-canvas-skia.md`. Generated by context-ingest; do not hand-edit._
