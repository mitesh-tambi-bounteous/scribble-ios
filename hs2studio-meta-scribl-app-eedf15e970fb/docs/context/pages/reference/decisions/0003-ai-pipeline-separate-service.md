...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0003-ai-pipeline-separate-service.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0003: AI pipeline is a separate service, not inline in request Lambdas

_Source artifact: `s2d/inputs/reference/decisions/0003-ai-pipeline-separate-service.md`. Generated by context-ingest; do not hand-edit._
