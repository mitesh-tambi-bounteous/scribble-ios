---
title: "Project Information: pages/reference/decisions/0004-dynamodb-single-table"
---

<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0004-dynamodb-single-table.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0004: Aurora Serverless v2 (PostgreSQL) as system of record

_Source artifact: `s2d/inputs/reference/decisions/0004-dynamodb-single-table.md`. Generated by context-ingest; do not hand-edit._
