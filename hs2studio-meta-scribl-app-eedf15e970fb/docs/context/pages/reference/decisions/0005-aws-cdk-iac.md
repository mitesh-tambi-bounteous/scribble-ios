...
<!-- Generated by docs-sync from `s2d/context/pages/reference/decisions/0005-aws-cdk-iac.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# ADR 0005: AWS CDK (TypeScript) for all infrastructure

_Source artifact: `s2d/inputs/reference/decisions/0005-aws-cdk-iac.md`. Generated by context-ingest; do not hand-edit._
