---
title: "Project Information: pages/reference/arc-ideation-readme"
---

<!-- Generated by docs-sync from `s2d/context/pages/reference/arc-ideation-readme.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl -- Client Workspace

_Source artifact: `s2d/inputs/reference/arc-ideation-readme.md`. Generated by context-ingest; do not hand-edit._
