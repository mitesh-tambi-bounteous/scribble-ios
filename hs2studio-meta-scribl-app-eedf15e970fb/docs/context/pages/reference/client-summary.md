...
<!-- Generated by docs-sync from `s2d/context/pages/reference/client-summary.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl -- Client Summary

_Source artifact: `s2d/inputs/reference/client-summary.md`. Generated by context-ingest; do not hand-edit._
