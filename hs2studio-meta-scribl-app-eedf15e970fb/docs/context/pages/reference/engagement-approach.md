...
<!-- Generated by docs-sync from `s2d/context/pages/reference/engagement-approach.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C -- Bounteous Engagement Approach

_Source artifact: `s2d/inputs/reference/engagement-approach.md`. Generated by context-ingest; do not hand-edit._
