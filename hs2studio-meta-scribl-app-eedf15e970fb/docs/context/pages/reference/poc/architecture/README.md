...
<!-- Generated by docs-sync from `s2d/context/pages/reference/poc/architecture/README.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C -- AWS Architecture

_Source artifact: `s2d/inputs/reference/poc/architecture/README.md`. Generated by context-ingest; do not hand-edit._
