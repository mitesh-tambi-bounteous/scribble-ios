...
<!-- Generated by docs-sync from `s2d/context/pages/reference/poc/architecture/cost-model.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C -- Infrastructure Cost / TCO Model

_Source artifact: `s2d/inputs/reference/poc/architecture/cost-model.md`. Generated by context-ingest; do not hand-edit._
