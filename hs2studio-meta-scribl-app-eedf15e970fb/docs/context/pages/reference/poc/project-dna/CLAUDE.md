---
title: "Project Information: pages/reference/poc/project-dna/CLAUDE"
---

<!-- Generated by docs-sync from `s2d/context/pages/reference/poc/project-dna/CLAUDE.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C POC -- Claude project guide

_Source artifact: `s2d/inputs/reference/poc/project-dna/CLAUDE.md`. Generated by context-ingest; do not hand-edit._
