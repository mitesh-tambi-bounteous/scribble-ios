...
<!-- Generated by docs-sync from `s2d/context/pages/reference/architecture-plan.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Architecture plan

_Source artifact: `s2d/inputs/reference/architecture-plan.md`. Generated by context-ingest; do not hand-edit._
