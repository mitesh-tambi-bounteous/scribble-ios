...
<!-- Generated by docs-sync from `s2d/context/pages/reference/technical-implementation-plan.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C -- Technical Implementation Plan

_Source artifact: `s2d/inputs/reference/technical-implementation-plan.md`. Generated by context-ingest; do not hand-edit._
