---
title: "Project Information: pages/reference/scribl-team-model"
---

<!-- Generated by docs-sync from `s2d/context/pages/reference/scribl-team-model.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl D2C -- Team Model

_Source artifact: `s2d/inputs/reference/scribl-team-model.md`. Generated by context-ingest; do not hand-edit._
