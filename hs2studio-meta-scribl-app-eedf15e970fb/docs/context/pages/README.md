---
title: "Project Information: pages/README"
---

<!-- Generated by docs-sync from `s2d/context/pages/README.md`. Do not hand-edit; edit the
     source and re-run `npm run docs:sync`. -->

# Scribl inputs -- provenance and audit trail

_Source artifact: `s2d/inputs/README.md`. Generated by context-ingest; do not hand-edit._
