...
<!-- Generated by docs-sync from `s2d/context/future-architecture-aws.md`. Do not hand-edit; edit the
...
## Cost model (from `s2d/inputs/scribl-d2c-aws-estimate-v3.xlsx`)
